...
public class ViewOpenActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thiscontext = ViewOpenActivity.this;
			 ...
			 public void onSuccess(String response) {
                 ...
                 try {
                     ...
                     if(succ == 1){
                    	  ...
                    	  table_layout = (TableLayout)findViewById(R.id.tlStockRows);
	...
	private View.OnClickListener tablerowOnClickListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent stockIntent = new Intent(thiscontext,UpdateStockDetails.class);
